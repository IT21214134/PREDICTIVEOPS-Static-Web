            ...
            content: (
                <div>
                    ...
                    <p className="text-2xl text-neutral-600 dark:text-neutral-400 mb-2">
                        A Topic Assessment Form ensures the final year research project is feasible, relevant, and academically valid before full-scale work begins.
                    </p>
                    <br></br>
                    <p className="text-xs font-bold">Marks Allocated: 0</p>
